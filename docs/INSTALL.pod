...
=head2 Installation Walkthrough (for Gentoo)

This section will walk you through an installation of RAL on two machines
running Gentoo. This is only an example; tweak the instructions to fit your
