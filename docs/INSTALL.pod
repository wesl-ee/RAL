...
Additionally, RAL calls `git` to fetch the version number and display it at the
bottom of some pages.
...
If you decide to deploy using http/2 and C<CONFIG_REALTIME_ENABLE>
