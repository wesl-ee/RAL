...
L<Paractically requires SSL|https://www.nginx.com/wp-content/uploads/2015/09/NGINX_HTTP2_White_Paper_v4.pdf> In this case, nginx will also act as a SSL termination proxy;
