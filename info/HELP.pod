...
C<author> is the cited author. This will be appended to the bottom of the
blockquote as if the author said the quote.
...
Hide text from the casual viewer
...
=head3 Valid BBCode Markdown Examples
	...
	[quote=OP]I don't know left from right[/quote]
...
L<Prettyboy-Yumi|https://prettyboytellem.com> is the sysop, sole protector
and guardian angel of RAL and can be reached via prayer or by mail:
L<yumi@prettyboytellem.com|mailto:yumi@prettyboytellem.com>
